...
const AuthForm = ({ formType }: Props) => {
  ...
  return (
    <form className={`flex flex-col gap-4 w-full`} action={action}>
        ...
        <div>
          <div className="relative">
            <Input
              ...
              className="py-5  pr-10 border border-gray-300 rounded-md focus-visible:ring-1 focus-visible:ring-blue-300 focus-visible:border-blue-300"
            />
            <button
              type="button"
      ...
      <SubmitButton className=" py-5 bg-gradient-to-br from-sky-500 to-indigo-500 text-white cursor-pointer">
        Sign Up
      </SubmitButton>
    </form>
  );
